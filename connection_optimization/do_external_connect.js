 ...
 * in external_connect.js for Sing Along. Parses the room name and JSON Web
 * Token (JWT) from the URL and executes createConnectionExternally.
 *
 * NOTE: If you are using lib-jitsi-meet without Sing Along, you should use this
 * file as reference only because the implementation is Sing Along-specific.
 *
