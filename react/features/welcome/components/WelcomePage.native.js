...
import { Icon, IconMenu, IconWarning, IconAdd } from '../../base/icons';
            ...
            <LocalVideoTrackUnderlay style = { styles.welcomePage }>
                <View style = { _headerStyles.page }>
                    ...
                    <SafeAreaView style = { styles.roomContainer } >
                        <TouchableOpacity style = { styles.joinControls }
                                                        onPress = { () => Linking.openURL("https://hallelujahgospel.com/backoffice/live-events/create")}
                        ...
                        style={styles.textInputt}>
                            ...
                            >
                                ...
                                >
                                    <Text
                                    style={{ color: "white", fontSize: 20, left: -15 }}
                                    >
