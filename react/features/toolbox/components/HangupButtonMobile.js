...
import CallEndPopOver from "./EndCallDialog"    
import EndCallForUser from "./EndCallForUser"
 ...
 */
class HangupButtonMobile extends AbstractHangupButton<Props, *> {
        _hangup: Function;
    ...
    constructor(props: Props) {
        ...
        this._hangup = () => {
            ...
            if (navigator.product === 'ReactNative') {
                ...
                console.log("here", this.props._isLocalBuddyModerator   )
...
export default translate(connect(_mapStateToProps)(HangupButtonMobile));
