...
class OverflowMenu extends PureComponent<Props, State> {
     ...
     */
    render() {
        const { _bottomSheetStyles, _isLocalBuddyModerator } = this.props;
        ...
        return (
            <BottomSheet
                ...
                <Collapsible collapsed = { !showMore }>
                    ...
                    {_isLocalBuddyModerator && <RecordButton { ...buttonProps } />}
                    {_isLocalBuddyModerator && <MuteEveryoneButton {...buttonProps }/>}
                    {/* {_isLocalBuddyModerator && <LiveStreamButton { ...buttonProps } />} */}
                    {/* {_isLocalBuddyModerator && <VideoShareButton { ...buttonProps } />} */}
                    {_isLocalBuddyModerator && <RoomLockButton { ...buttonProps } />}
                    {/* {_isLocalBuddyModerator && <ClosedCaptionButton { ...buttonProps } />} */}
