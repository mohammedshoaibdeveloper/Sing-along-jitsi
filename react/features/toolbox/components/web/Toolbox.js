...
import ReportButtonWeb from '../ReportButtonWeb';
    ...
    */
    ...
    _renderOverflowMenuContent() {
        ...
        return [
            ...
            // this.props._isLocalBuddyModerator && <LiveStreamButton
            //     key = 'livestreaming'
            //     showLabel = { true } />,
            this.props._isLocalBuddyModerator && <RecordButton
                key = 'record'
                showLabel = { true } />,
            // this._shouldShowButton('sharedvideo') && this.props._isLocalBuddyModerator  
            //     && <OverflowMenuItem
        ...
        return (
            <div className = 'toolbox-content'>
                ...
                <div className = 'button-group-right'>
                    ...
                    {this.props._isLocalBuddyModerator && <button 
                    onClick={() => {
                    ...
                    className="btn btn-stroke" data-toggle="modal" data-target="#endmeeting" style={{"fontSize":"14px","height":"35px","borderRadius":".35rem","background":"red","border":"1px solid red","marginLeft":"10px","color":"white", cursor: "pointer"}}>End Meeting</button>}
