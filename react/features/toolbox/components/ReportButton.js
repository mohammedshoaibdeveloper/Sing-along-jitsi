...
import { ReportIconMobile } from '../../base/icons';
...
class ReportButton extends AbstractButton<Props, *> {
    accessibilityLabel = 'toolbar.accessibilityLabel.help';
    icon = ReportIconMobile;
    label = 'Report';
...
export default translate(connect(_mapStateToProps)(ReportButton));
