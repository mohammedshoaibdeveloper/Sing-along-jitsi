        ...
        if (_isDropboxEnabled
            ...
            appData = JSON.stringify({
                'file_recording_metadata': {
                    ...
                    'eventId': this.props._eventId,
                    'eventSlug': this.props._eventSlug
                }
            });
...
export function mapStateToProps(state: Object) {
    ...
    return {
        ...
        _eventId: state['features/base/jwt'].user.event_id,
        _eventSlug: state['features/base/jwt'].user.event_slug
    };
}
