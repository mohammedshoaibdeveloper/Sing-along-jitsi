...
import { setJWT, setEventId, setEventSlug } from './actions';
 ...
 * }}
 */
function _user2participant({ avatar, avatarUrl, email, id, name, event_id, event_slug }) {
    const participant = {};
    ...
    if (typeof event_slug === 'string') {
        participant.event_slug = event_slug.trim()
    }
