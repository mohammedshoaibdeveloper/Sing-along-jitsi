...
/**
 * Signals that the configuration (commonly known in Sing Along as config.js)
...
/**
 * Signals that a configuration (commonly known in Sing Along as config.js)
...
/**
 * Stores a specific Sing Along config.js object into {@code localStorage}.
 *
 * @param {string} baseURL - The base URL from which the config.js was
 * downloaded.
 * @param {Object} config - The Sing Along config.js to store.
 * @returns {Function}
 */
