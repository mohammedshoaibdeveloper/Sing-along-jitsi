 ...
 * JitsiMeetJS#init(). The app will download config.js from the Sing Along
 ...
 * The app will download config.js from the Sing Along deployment and take its
 ...
 * config.js from the Sing Along deployment and take its values into account but
...
function _setConfig(state, { config }) {
    ...
    const newState = _.merge(
        ...
        // downloaded from the Sing Along deployment because the former contains
