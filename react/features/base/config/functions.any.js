...
/**
 * Restores a Sing Along config.js from {@code localStorage} if it was
 ...
 * @returns {?Object} The Sing Along config.js which was previously downloaded
...
export function setConfigFromURLParams(
    ...
    //     "interfaceConfig.APP_NAME": "Sing Along"
    // }
    // We want to have:
    // json = {
    //     config: {
