...
class DeepLinkingMobilePage extends Component<Props> {
            ...
            <div className = { _SNS }>
                ...
                <div className = { `${_SNS}__body` }>
                    ...
                    <a
                        ...
                        href = { `https://join.hallelujahgospel.com/?link=https://live.hallelujahgospel.com/${_room}&apn=com.hallelujahgospel.live` }
    ...
    _generateDownloadURL() {
        ...
        const IUS = interfaceConfig.APP_SCHEME || 'com.hallelujahgospel.live';
