...
export function generateDeepLinkingURL() {
    ...
    const appScheme = interfaceConfig.APP_SCHEME || 'com.hallelujahgospel.live';
    ...
    if (Platform.OS === 'android') {
        // https://live.hallelujahgospel.com/foo -> live.hallelujahgospel.com/foo
        const url = href.replace(regex, '').substr(2);
        const pkg = interfaceConfig.ANDROID_APP_PACKAGE || 'com.hallelujahgospel.live';
