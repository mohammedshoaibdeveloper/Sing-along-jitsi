    ...
    private static List<NativeModule> createNativeModules(ReactApplicationContext reactContext) {
        List<NativeModule> nativeModules
            = new ArrayList<>(Arrays.<NativeModule>asList(
                ...
                new com.hallelujahgospel.live.sdk.net.NAT64AddrInfoModule(reactContext)));
        ...
        try {
            Class<?> amplitudeModuleClass = Class.forName("com.hallelujahgospel.live.sdk.AmplitudeModule");
