package com.hallelujahgospel.live.sdk;
...
import com.hallelujahgospel.live.sdk.log.JitsiMeetLogger;
...
/**
 * Sing Along implementation of {@link ConnectionService}. At the time of this
...
public class ConnectionService extends android.telecom.ConnectionService {
    ...
    static final String EXTRA_PHONE_ACCOUNT_HANDLE
        = "com.hallelujahgospel.live.sdk.connection_service.PHONE_ACCOUNT_HANDLE";
    ...
    /**
     * Connection implementation for Sing Along's {@link ConnectionService}.
     *
     * @author Pawel Domas
     */
    class ConnectionImpl extends Connection {
        ...
        public void onDisconnect() {
            ...
            ReactInstanceManagerHolder.emitEvent(
                    "com.hallelujahgospel.live:features/connection_service#disconnect",
                    data);
        ...
        public void onAbort() {
            ...
            data.putString("callUUID", getCallUUID());
            ReactInstanceManagerHolder.emitEvent(
                    "com.hallelujahgospel.live:features/connection_service#abort",
                    data);
            // The JavaScript side will not go back to the native with
            // 'endCall', so the Connection must be removed immediately.
            setConnectionDisconnected(
