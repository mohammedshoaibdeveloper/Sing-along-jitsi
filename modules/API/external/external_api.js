...
export default class JitsiMeetExternalAPI extends EventEmitter {
    /**
     * Constructs new API instance. Creates iframe and loads Sing Along in it.
     *
     * @param {string} domain - The domain name of the server that hosts the
     * conference.
    ...
    /**
     * Getter for the large video element in Sing Along.
     *
    ...
    /**
     * Getter for participant specific video element in Sing Along.
     *
     ...
     * {@code readyToClose} - all hangup operations are completed and Sing Along
    ...
    /**
     * Removes the listeners and removes the Sing Along frame.
     *
     * @returns {void}
     */
    dispose() {
    ...
    /**
     * Returns the iframe that loads Sing Along.
     *
